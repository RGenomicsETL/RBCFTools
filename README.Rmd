...
Export VCF/BCF to a "tidy" format where each row is one variant-sample combination. This transforms wide `FORMAT_<field>_<sample>` columns into a single `SAMPLE_ID` column plus `FORMAT_<field>` columns.
