...
**Streaming mode for large files:** Use `streaming = TRUE` to avoid loading the entire VCF into R memory. This streams VCF → Arrow IPC (nanoarrow) → Parquet (DuckDB), keeping memory usage minimal:
