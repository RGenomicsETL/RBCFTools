...
The Arrow supports involves a lot of copies at the C level, let alone additional copies and converstions when converting to parquet including Arrow IPC file serialization. Same limitation applies to the Arrow based SQL query interface. There is no particular attempt to parse further vep/snpeff/annovar info fields.
