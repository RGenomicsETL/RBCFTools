...
Arrow stream still copies at the C level and again on Parquet conversion (Arrow IPC serialization); optimizing zero-copy paths remains open. The duckdb extension can be improve with ranged request for indexed files even when region is not specicied.
