...
#> Wrote 11 rows to /tmp/RtmpFcNEZi/file20874312838289.parquet
...
#> 1 /tmp/RtmpFcNEZi/file20874312838289.parquet            0                 11
#> 2 /tmp/RtmpFcNEZi/file20874312838289.parquet            0                 11
#> 3 /tmp/RtmpFcNEZi/file20874312838289.parquet            0                 11
#> 4 /tmp/RtmpFcNEZi/file20874312838289.parquet            0                 11
#> 5 /tmp/RtmpFcNEZi/file20874312838289.parquet            0                 11
#> 6 /tmp/RtmpFcNEZi/file20874312838289.parquet            0                 11
...
#> Wrote 11 rows to /tmp/RtmpFcNEZi/file208743779e686e.parquet (streaming mode)
...
#>   Output: /tmp/tmp.8OQF9YmlST.parquet 
#>   Compression: zstd 
#>   Batch size: 10000 
#>   Threads: 1 
#>   Streaming: FALSE 
...
#> Wrote 11 rows to /tmp/tmp.8OQF9YmlST.parquet
#> 
#> ✓ Conversion complete!
#>   Time: 0.48 seconds
#>   Output size: 0.01 MB
...
#> 9  YES <NA>    <NA>  <NA>
#> Unknown option: 0 
#> Parquet File Information: /tmp/tmp.8OQF9YmlST.parquet 
#> 
#> File size: 0.01 MB 
#> Total rows: 11 
